    ...
    return (
        <div>
            ...
            >
                ...
                <Form.Item label="Slippage (%)" name="perSlippage" initialValue={8} rules={[{ required: true, message: 'Please input' }]}>
                    <InputNumber style={{ width: "100%" }} />
                </Form.Item>
                <Form.Item label="Gas Price" name="gasPrice" initialValue={7} rules={[{ required: true, message: 'Please input' }]}>
                    <InputNumber style={{ width: "100%" }} />
                </Form.Item>
                ...
                <Form.Item>
                    ...
                    <br />
                    {
                        props.web3 ? <div>
                            ...
                            <Button onClick={() => props.onConnectWallet()} loading={props.loading} style={{ width: "100%" }} type="primary" danger>Connect Metamask</Button>
                        </div>
                    }
                </Form.Item>
            </Form>
